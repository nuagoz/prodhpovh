		    ...
		    <div class="card hovercard">
		        ...
		        <div class="useravatar">
		        	...
		        	<div class="rank-label-container">
                    	<span id="zone_points" class="label label-default rank-label"><?=$points_membre;?> points</span>
                	</div>
		        </div>
		        <div class="card-info"> <span id="pseudo_profile" class="harrypotter"><?=$pseudo_membre;?></span>
